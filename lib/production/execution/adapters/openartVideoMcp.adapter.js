  ...
  async estimate({ job }) {
    ...
    if (!providerInput?.model || !providerInput?.prompt || !providerInput?.durationSeconds || !providerInput?.aspectRatio || !providerInput?.resolution) {
      return {
        ...
        unit: 'provider_credits', providerCreditUnit: 'openart-credits', provisional: true, approvalRequired: true,
    ...
    try {
      ...
      if (typeof credits === 'number') {
        return {
          ...
          costTier: null,
          currency: 'openart-credits',
        unit: 'provider_credits', providerCreditUnit: 'openart-credits',
          provisional: false,
