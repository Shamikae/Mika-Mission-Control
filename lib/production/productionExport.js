...
// Explicit .js extension: webpack resolves the extensionless form, but Node's
// native ESM loader does not — and without it this module (and therefore the
// whole provider adapter registry that reaches it via manualExport.adapter.js)
// cannot be imported by a validator script at all.
import { modeLabel } from './productionRules.js';
