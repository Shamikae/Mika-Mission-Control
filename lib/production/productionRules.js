...
// ── Provider catalog ──────────────────────────────────────────────────────
// `status` here is the honest DEFAULT. Three entries are patched at runtime
...
// higgsfield-mcp (lib/production/higgsfieldMcpAvailability.js), and
// openart-video (lib/production/openartVideoMcpAvailability.js). Every other
// provider's status is a fixed, documented governance decision: heygen/
// higgsfield (the old, staged, Direct-API entries) have adapter *files* but
// their execute() unconditionally throws; hyperframes has no adapter at all.
