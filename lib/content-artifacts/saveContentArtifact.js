...
const STAGE_TO_FILENAME = {
  ...
  thumbnail_generation: 'thumbnail.md',
  cta_creation:         'cta.md',
};
...
export const ARTIFACT_STAGES = [
  ...
  { stageId: 'thumbnail_generation', filename: 'thumbnail.md',   icon: '🖼', label: 'Thumbnail'     },
  { stageId: 'cta_creation',         filename: 'cta.md',         icon: '📣', label: 'CTA'           },
];
