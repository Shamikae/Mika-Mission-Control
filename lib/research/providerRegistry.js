...
// Tavily and Brave Search are documented, honestly "staged" entries this
// milestone (per the audit: neither has a real adapter implementation yet
// — only Exa does) so a future milestone can activate one without any
// registry shape change. model-synthesis is always available as the
// non-search fallback mode.
...
const REGISTRY_ENTRIES = [
  ...
  },
  {
    ...
    displayName: 'Tavily',
    executionType: 'api_key',
    capabilities: ['llm_optimized_search', 'inline_content_extraction'],
    hasAdapter: false,
  },
  {
    id: 'brave-search',
