// POST /api/hyperframes/compositions/[id]/lint
// Runs `hyperframes lint --json` to completion (fast) and returns the run.

import { isValidCompositionId } from '../../../../../lib/hyperframes/hyperframesSecurity';
import { runHyperFramesLint } from '../../../../../lib/hyperframes/hyperframesRunner';
...
export default async function handler(req, res) {
  ...
  try {
    const run = await runHyperFramesLint(id);
