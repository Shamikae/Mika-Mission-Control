// POST /api/production/providers/heygen/connect
// Begins the HeyGen MCP OAuth flow: performs (or reuses) dynamic client
...
import { beginHeyGenAuthorization, buildHeyGenCallbackUrl } from '../../../../../lib/heygen/heygenMcpClient';
...
export default async function handler(req, res) {
  ...
  try {
    const result = await beginHeyGenAuthorization(redirectUrl);
